...
parser.add_argument('-t', '--threshold', type=float, required=True, help='The threshold for the ratio.')
...
with open(os.path.join(THIS_DIR, 'created_questions_md-{}-{}.json'.format(ratio_threshold, model)), 'w', encoding='utf-8') as f:
