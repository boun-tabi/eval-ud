...
example_output="""1936 yılındayız."""
...
template="""
The following is a parse of a Turkish sentence with the surface forms hidden. The format is called CONLL-U.

{example_input}

Your task is to recover the hidden surface forms and write your answer in a single line. For example, your answer for the previous parse should be

{example_output}

Now, analyze the following test example and try to recover the hidden surface forms and write your answer in a single line.
