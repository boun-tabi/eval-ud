...
def get_best_worst(accuracies, output_d):
...
def main():
    ...
    for sent_id in sent_ids:
        ...
        output_d[sent_id] = {'original_text': original_text, version1: v1_llm, version2: v2_llm, person1: {version1: v1_p1, version2: v1_p2}, person2: {version1: v2_p1, version2: v2_p2}}
    ...
    best_worst_d['llm']['best'], best_worst_d['llm']['worst'] = get_best_worst(llm_accuracies, output_d)
    best_worst_d[person1]['best'], best_worst_d[person1]['worst'] = get_best_worst(p1_accuracies, output_d)
    best_worst_d[person2]['best'], best_worst_d[person2]['worst'] = get_best_worst(p2_accuracies, output_d)
