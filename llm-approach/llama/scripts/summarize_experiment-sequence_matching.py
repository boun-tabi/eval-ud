...
if 'v2.8_output-cleaned.json' in os.listdir(run_dir) and 'v2.11_output-cleaned.json' in os.listdir(run_dir):
    v2_8_out = os.path.join(run_dir, 'v2.8_output-cleaned.json')
    v2_11_out = os.path.join(run_dir, 'v2.11_output-cleaned.json')
else:
...
for sent_id in v2_8_results.keys():
    original_text, output_text = v2_8_results[sent_id]['original_text'], v2_8_results[sent_id]['output_text']
...
for sent_id in v2_11_results.keys():
    original_text, output_text = v2_11_results[sent_id]['original_text'], v2_11_results[sent_id]['output_text']
