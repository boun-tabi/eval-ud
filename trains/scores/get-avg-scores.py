...
scores_d['dep_parsing_upos_feats_MTL'] = {'2.8': {'UPOS': list(), 'UFeats': list(), 'UAS': list(), 'LAS': list()}, '2.11': {'UPOS': list(), 'UFeats': list(), 'UAS': list(), 'LAS': list()}, '2.11-unr': {'UPOS': list(), 'UFeats': list(), 'UAS': list(), 'LAS': list()}}
...
scores_d['dep_parsing_feats_MTL'] = {'2.8': {'UFeats': list(), 'UAS': list(), 'LAS': list()}, '2.11': {'UFeats': list(), 'UAS': list(), 'LAS': list()}, '2.11-unr': {'UFeats': list(), 'UAS': list(), 'LAS': list()}}
scores_d['dep_parsing_lemma_MTL'] = {'2.8': {'Lemmas': list(), 'UAS': list(), 'LAS': list()}, '2.11': {'Lemmas': list(), 'UAS': list(), 'LAS': list()}, '2.11-unr': {'Lemmas': list(), 'UAS': list(), 'LAS': list()}}
